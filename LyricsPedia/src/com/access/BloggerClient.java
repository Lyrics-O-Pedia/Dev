...
public class BloggerClient {
 ...
 public static void run(BloggerService myService, String userName,
   ...
   String htmlImg = "<a href=\"http://4.bp.blogspot.com/-XTgrgwQ8_0g/U9412Q7qKnI/AAAAAAAAAMg/5KsR8Z0S7OI/s1600/manade+belagayithe.png\" imageanchor=\"1\" style=\"clear: left; float: left; margin-bottom: 1em; margin-right: 1em;\"><img border=\"0\" src=\"http://4.bp.blogspot.com/-XTgrgwQ8_0g/U9412Q7qKnI/AAAAAAAAAMg/5KsR8Z0S7OI/s1600/manade+belagayithe.png\" height=\"177\" width=\"320\" /></a>";

   // Demonstrate how to create a draft post.
   Entry draftPost = createPost(myService,  " Snorkling in Aruba",
		   htmlImg + " <p>We had so much fun snorkling in Aruba<p>", "Post author", userName,
       true);
   ...
   Entry publicPost = createPost(myService, " Back from vacation",
		   htmlImg + " <p>I didn't want to leave Aruba, but I ran out of money :(<p>",
...
//   deletePost(myService, publicPost.getEditLink().getHref());
 ...
 public static void main(String[] args) {
   ...
   try {
     run(myService, username, password);
